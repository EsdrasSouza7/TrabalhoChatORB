...
Chat._d_sendMessage = (((omniORB.tcInternal.tv_string,0), ), (), None)
Chat._d_receiveMessage = ((), ((omniORB.tcInternal.tv_string,0), ), None)
Chat._d_calculadora = ((), ((omniORB.tcInternal.tv_string,0), ), None)
...
class Chat (PortableServer.Servant):
    ...
    _omni_op_d = {"sendMessage": _0_ChatApp.Chat._d_sendMessage, "receiveMessage": _0_ChatApp.Chat._d_receiveMessage, "calculadora": _0_ChatApp.Chat._d_calculadora}
