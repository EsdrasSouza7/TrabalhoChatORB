# Python stubs generated by omniidl from Exemplo.idl
...
#
__name__ = "Example"
_0_Example = omniORB.openModule("Example", r"Exemplo.idl")
_0_Example__POA = omniORB.openModule("Example__POA", r"Exemplo.idl")
