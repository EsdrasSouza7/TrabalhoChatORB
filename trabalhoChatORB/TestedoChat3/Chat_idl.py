...
Chat._d_sendPublicMessage = (((omniORB.tcInternal.tv_string,0), (omniORB.tcInternal.tv_string,0)), (), None)
...
class _objref_Chat (CORBA.Object):
    ...
    def sendPublicMessage(self, *args):
        return self._obj.invoke("sendPublicMessage", _0_ChatApp.Chat._d_sendPublicMessage, args)
...
class Chat (PortableServer.Servant):
    ...
    _omni_op_d = {"sendMessage": _0_ChatApp.Chat._d_sendMessage, "receiveMessage": _0_ChatApp.Chat._d_receiveMessage, "joinChat": _0_ChatApp.Chat._d_joinChat, "leaveChat": _0_ChatApp.Chat._d_leaveChat, "listUsers": _0_ChatApp.Chat._d_listUsers, "sendPublicMessage": _0_ChatApp.Chat._d_sendPublicMessage}
