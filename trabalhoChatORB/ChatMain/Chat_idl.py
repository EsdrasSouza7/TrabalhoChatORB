...
Chat._d_calculadora = (((omniORB.tcInternal.tv_string,0), ), (omniORB.tcInternal.tv_double, ), None)
...
class _objref_Chat (CORBA.Object):
    ...
    def calculadora(self, *args):
        return self._obj.invoke("calculadora", _0_ChatApp.Chat._d_calculadora, args)
...
class Chat (PortableServer.Servant):
    ...
    _omni_op_d = {"sendMessage": _0_ChatApp.Chat._d_sendMessage, "receiveMessage": _0_ChatApp.Chat._d_receiveMessage, "joinChat": _0_ChatApp.Chat._d_joinChat, "leaveChat": _0_ChatApp.Chat._d_leaveChat, "listUsers": _0_ChatApp.Chat._d_listUsers, "calculadora": _0_ChatApp.Chat._d_calculadora}
